        ...
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          ...
          <div className="border-t border-slate-300 pt-4 mt-6">
            <p className="text-xs text-slate-500 text-center">
              BWGA Ai * Technical Architecture Report * Version 3.2 * January 2026<br/>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border border-slate-200 rounded-lg overflow-hidden hover:border-slate-400 hover:shadow-lg transition-all">
                ...
                <div className="p-6 bg-white">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-300 text-xs text-slate-500 text-center">
                    Generated by BWGA Ai * ABN: 55 978 113 300 * This report is confidential and intended for internal strategic planning purposes only.
                  </div>
                </div>
                )}
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-lg overflow-hidden hover:border-slate-400 hover:shadow-lg transition-all">
                ...
                <div className="p-6 bg-white">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-300 text-xs text-slate-500 text-center">
                    Generated by BWGA Ai * ABN: 55 978 113 300
                  </div>
                </div>
                )}
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-lg overflow-hidden hover:border-slate-400 hover:shadow-lg transition-all">
                ...
                <div className="p-6 bg-white">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-300 text-xs text-slate-500 text-center">Generated by BWGA Ai * ABN: 55 978 113 300</div>
                </div>
                )}
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-center md:text-left">
                <p className="text-sm text-slate-400">
                  A(c) 2026 BW Global Advisory. All rights reserved. | brayden@bwglobaladvis.info | +63 960 835 4283
                </p>
