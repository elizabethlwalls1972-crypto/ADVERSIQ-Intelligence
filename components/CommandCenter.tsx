                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
                        <div>
                            ...
                            <p className="text-lg text-white/70 leading-relaxed mb-6">
                                The analysis that governments, investment committees, and boards have historically paid six figures to receive is now available as a single platform run. ADVERSIQ fills the gaps — delivering verified, auditable intelligence output in minutes, whether you have a team behind you or not.
                            </p>
                            <p className="text-base text-white/50 leading-relaxed">
                                Every analysis is mathematically scored, adversarially stress-tested, and independently verified across ten pipeline layers before it reaches you. Not a report generated by a model. A position that has survived challenge.
                            </p>
                        </div>
