                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
                        <div>
                            ...
                            <p className="text-lg text-white/70 leading-relaxed mb-6">
                                The analysis that governments, investment committees, and boards have historically paid six figures to receive is now available as a single platform run. ADVERSIQ replaces weeks of advisory engagement with a verified, auditable intelligence output — delivered in minutes.
                            </p>
